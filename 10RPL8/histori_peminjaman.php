...
<table class="table table-hover table-striped">
    ...
    <tbody>
        ...
        while ($dt_histori = mysqli_fetch_array($qry_histori)) {
            ...
            $buku_dipinjam = "<ol>";
            $qry_buku = mysqli_query($conn, "select * from  detail_peminjaman_buku join daftar_buku on daftar_buku.id_buku=detail_peminjaman_buku.id_buku where id_peminjaman_buku = '" . $dt_histori['id_peminjaman_buku'] . "'");
